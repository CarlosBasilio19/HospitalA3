 ...
 * @author raphael
 */
public class EditarDoutor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Registro de Doutores");

        jLabel2.setText("ID do Doutor");

        jLabel3.setText("Nome do Doutor:");

        jLabel4.setText("Especialização do Doutor:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarDoutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarDoutor().setVisible(true);
            }
        });
    }
